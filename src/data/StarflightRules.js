...
export class StarflightSession{
 ...
 tick(dt,input){
  ...
  for(const b of this.bullets){const ox=b.x,oy=b.y;if(b.gravity)b.vy+=b.gravity*dt;if(b.forestDelay>0){b.forestDelay-=dt;if(b.forestDelay<=0&&!b.boosted){b.vx*=4.5;b.vy*=4.5;b.boosted=true;this.emit('forestTick',b.x,b.y);}}b.x+=b.vx*dt;b.y+=b.vy*dt;if(b.bounceY&&(b.y<18||b.y>462)){b.y=clamp(b.y,18,462);b.vy*=-1;}b.life-=dt;
