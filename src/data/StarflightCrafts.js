export const STAR_CRAFTS=[
 ...
 {id:'owl',boost:0.5,bells:['廣域羽扇', '環繞護羽', '四向旋羽', '夜翼連奏'],hurtbox:{rx:35,ry:30},name:'旋羽貓頭鷹',role:'防守反擊',size:'中大型',width:158,anchor:[.60,.63],speed:230,hp:2,radius:5.6,cd:.6,energy:1.3,trait:'旋羽護盾',tip:'扇形羽刃・四向旋羽',motion:'懸浮拍翼・護羽環繞',file:'owl-storybook-v2.png'},
